...
{
    public class MissionPlannerViewModel : AppViewModelBase
    {
        IConnectedUasManager _connectedUasManager;
        IMissionPlanner _missionPlanner;

        public MissionPlannerViewModel(IConnectedUasManager connectedUasManager, IMissionPlanner missionPlanner)
        {
